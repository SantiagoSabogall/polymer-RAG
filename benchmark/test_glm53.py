...
async def process_file(client: AsyncOpenAI, semaphore: asyncio.Semaphore, md_path: Path, total: int) -> dict:
...
async def main():
    ...
    tasks = [process_file(client, semaphore, md, total) for md in md_files]
